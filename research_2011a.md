...
Oklahoma’s Maternal, Infant, Early Childhood Home Visitation (MIECHV) Expansion project has two primary branches  of evaluation, the *internal* evaluation conducted by the Oklahoma State Dept. of Health (OSDH) and the *external* evaluation conducted by the OU Health Sciences Center, Center on Child Abuse and Neglect (CCAN).  This summary report describes the progress to date for the external evaluation which uses a mixed‐method (quantitative/qualitative) approach to inform and evaluate change in five specific targeted areas identified for improvement: 
 ...
 1. _Systems Coordination_: Evaluate the impact of existing and developing coordination between EBHV programs and other support services. 
 1. _Program Marketing_: Inform, develop, and evaluate the outreach efforts of MIECHV-funded marketing.
 1. _Client Enrollment_ and Retention: Inform, develop, and evaluate new methods for engagement and retention of clients in EBHV services.
 1. _Service Need_: Evaluate the overall need for child and family services within each community.  
 1. _HV Effectiveness and Improvement_: Establish a quality improvement and control system and evaluate effectiveness of the home visitation and early childhood services continuum.
 ...
 * For more information about the grant proposal, please see the
[funding page](./funding_2011a_.html).
